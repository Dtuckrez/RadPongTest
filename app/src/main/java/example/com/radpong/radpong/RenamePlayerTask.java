...
public class RenamePlayerTask extends AsyncTask<String, Void, Boolean> {

    public RenamePlayerTask() {
    ...
    protected Boolean doInBackground(String... paramsIn) {
        ...
        try {
            url = new URL("https://mobilebuild.rockpooldigital.com/radpong/api/" + "players/"+paramsIn[0]);
            ...
            args.put("playerId", paramsIn[0]);
            args.put("name", paramsIn[1]);
